...
<button type="button" tooltip="添加商品分类" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/admin.php/goods/addtype'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                <th class="text-center" width="15%">分类ID</th>
                                <th algin="left">商品分类名称</th>
                        ...
                        <tbody>
                             <?php if(is_array($result)): foreach($result as $k=>$v): ?><tr>
                                     ...
                                     <td align="center">
                                         <a href="/admin.php/Goods/edittype/id/<?php echo ($v["typeid"]); ?>" class="btn btn-primary btn-sm shiny">
                                             <i class="fa fa-edit"></i> 编辑
                                         </a>
                                         <a href="#" onClick="warning('确实要删除吗', '/admin.php/Goods/delt/id/<?php echo ($v["typeid"]); ?>')" class="btn btn-danger btn-sm shiny">
