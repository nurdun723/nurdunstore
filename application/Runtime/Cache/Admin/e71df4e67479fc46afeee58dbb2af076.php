                                    ...
                                    <div id="horizontal-form">
                                      <form class="form-horizontal" role="form" action="" method="post">
                                         <div class="form-group">
                                          ...
                                          <div class="form-group">
                                              <label for="typeName" class="col-sm-2 control-label no-padding-right">品牌图片：</label>
                                              <div class="col-sm-6">
                                                  <input class="form-control" id="brandLog" name="brandLog" type="file">
                                              </div>
                                          </div>
                                          <div class="form-group">
                                              <label for="typeName" class="col-sm-2 control-label no-padding-right">品牌网址：</label>
                                              <div class="col-sm-6">
                                                  <input class="form-control" id="brandUrl" name="brandUrl" type="text">
                                              </div>
                                              <p class="help-block col-sm-4 red">* 必填</p>
                                          </div>
                                            <div class="form-group">
